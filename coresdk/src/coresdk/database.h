 ...
 *
 * The SplashKit's database library allows you to easily create or load databases
 ...
 * it the desired name.
 *
 * @param name The name to check if a database is loaded.
 *
 * @returns Returns `true` if a database with the given `name` has
 * has been loaded.
 *
 * @attribute class   database
 * @attribute method  has_database
 */
 ...
 *
 * @attribute class   database
 * @attribute method  database_named
 */
 ...
 *
 * @attribute class   database
 * @attribute method  run_sql_on_db
 */
 ...
 *
 * @attribute class   database
 * @attribute method  run_sql_on_database_named
 */
 ...
 *
 * @attribute class   database
 * @attribute method  free_all_query_results
 */
 ...
 *
 * @attribute class   database
 * @attribute method  reset_query_result
 */
 ...
 * - Coule return: "INTEGER", "FLOAT", "TEXT", "NULL".
 *
 * @attribute class   database
 ...
 *
 * @attribute class   database
 * @attribute method  query_success
 */
 ...
 *
 * @param effect The `database` whose resources should be released.
 *
 * @attribute class       database
 ...
 *
 * @param effect The `string` denoting where the database is which should be released.
 *
 * @attribute class       database
 */
 ...
 *
 * @attribute class   database
 * @attribute method  free_all_databases
 */
