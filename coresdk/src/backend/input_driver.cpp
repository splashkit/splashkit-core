...
namespace splashkit_lib
{
    ...
    void _init_key_maps()
    {
        ...
        _sk_key_map[RIGHT_OPTION_KEY] = SDLK_RALT;
        _sk_key_map[LEFT_OPTION_KEY] = SDLK_LALT;
        _sk_key_map[LEFT_SUPER_KEY] = SDLK_LGUI;
        _sk_key_map[RIGHT_SUPER_KEY] = SDLK_RGUI;
        _sk_key_map[LEFT_WINDOWS_KEY] = SDLK_LGUI;
        _sk_key_map[RIGHT_WINDOWS_KEY] = SDLK_RGUI;
        _sk_key_map[LEFT_COMMAND_KEY] = SDLK_LGUI;
        _sk_key_map[RIGHT_COMMAND_KEY] = SDLK_RGUI;
        ...
        _sdl_key_map[SDLK_RALT] = RIGHT_OPTION_KEY;
        _sdl_key_map[SDLK_LALT] = LEFT_OPTION_KEY;
        _sdl_key_map[SDLK_LGUI] = LEFT_SUPER_KEY;
        _sdl_key_map[SDLK_RGUI] = RIGHT_SUPER_KEY;
        _sdl_key_map[SDLK_LGUI] = LEFT_WINDOWS_KEY;
        _sdl_key_map[SDLK_RGUI] = RIGHT_WINDOWS_KEY;
        _sdl_key_map[SDLK_LGUI] = LEFT_COMMAND_KEY;
        _sdl_key_map[SDLK_RGUI] = RIGHT_COMMAND_KEY;
