...
typedef struct {
    ...
    __sklib_string url;
    __sklib_string path;
    __sklib_int max_tokens;
    __sklib_double temperature;
    __sklib_double top_p;
    __sklib_int top_k;
    __sklib_double min_p;
    __sklib_double presence_penalty;
    __sklib_string prompt_append;
    __sklib_int seed;
} __sklib_language_model_options;
typedef struct {
