...
float __sklib__camera_x() {
    float __skreturn = camera_x();
    return __sklib__to_float(__skreturn);
}
float __sklib__camera_y() {
    float __skreturn = camera_y();
    return __sklib__to_float(__skreturn);
}
...
void __sklib__center_camera_on__sprite__float__float(__sklib_sprite s, float offset_x, float offset_y) {
    sprite __skparam__s = __sklib__to_sprite(s);
    float __skparam__offset_x = __sklib__to_float(offset_x);
    float __skparam__offset_y = __sklib__to_float(offset_y);
...
void __sklib__move_camera_by__float__float(float dx, float dy) {
    float __skparam__dx = __sklib__to_float(dx);
    float __skparam__dy = __sklib__to_float(dy);
...
float __sklib__to_screen_x__float(float world_x) {
    float __skparam__world_x = __sklib__to_float(world_x);
    float __skreturn = to_screen_x(__skparam__world_x);
    return __sklib__to_float(__skreturn);
}
float __sklib__to_screen_y__float(float world_y) {
    float __skparam__world_y = __sklib__to_float(world_y);
    float __skreturn = to_screen_y(__skparam__world_y);
    return __sklib__to_float(__skreturn);
}
...
float __sklib__to_world_x__float(float screen_x) {
    float __skparam__screen_x = __sklib__to_float(screen_x);
    float __skreturn = to_world_x(__skparam__screen_x);
    return __sklib__to_float(__skreturn);
}
float __sklib__to_world_y__float(float screen_y) {
    float __skparam__screen_y = __sklib__to_float(screen_y);
    float __skreturn = to_world_y(__skparam__screen_y);
    return __sklib__to_float(__skreturn);
}
...
float __sklib__brightness_of__color(__sklib_color c) {
    color __skparam__c = __sklib__to_color(c);
    float __skreturn = brightness_of(__skparam__c);
    return __sklib__to_float(__skreturn);
}
...
__sklib_color __sklib__hsb_color__float__float__float(float hue, float saturation, float brightness) {
    float __skparam__hue = __sklib__to_float(hue);
    float __skparam__saturation = __sklib__to_float(saturation);
    float __skparam__brightness = __sklib__to_float(brightness);
...
float __sklib__hue_of__color(__sklib_color c) {
    color __skparam__c = __sklib__to_color(c);
    float __skreturn = hue_of(__skparam__c);
    return __sklib__to_float(__skreturn);
}
...
__sklib_color __sklib__rgb_color__float__float__float(float red, float green, float blue) {
    float __skparam__red = __sklib__to_float(red);
    float __skparam__green = __sklib__to_float(green);
    float __skparam__blue = __sklib__to_float(blue);
...
__sklib_color __sklib__rgba_color__float__float__float__float(float red, float green, float blue, float alpha) {
    ...
    float __skparam__green = __sklib__to_float(green);
    float __skparam__blue = __sklib__to_float(blue);
    float __skparam__alpha = __sklib__to_float(alpha);
...
float __sklib__saturation_of__color(__sklib_color c) {
    color __skparam__c = __sklib__to_color(c);
    float __skreturn = saturation_of(__skparam__c);
    return __sklib__to_float(__skreturn);
}
...
int __sklib__get_next_row__query_result(__sklib_query_result result) {
    query_result __skparam__result = __sklib__to_query_result(result);
    bool __skreturn = get_next_row(__skparam__result);
    return __sklib__to_int(__skreturn);
}
...
int __sklib__has_row__query_result(__sklib_query_result result) {
    query_result __skparam__result = __sklib__to_query_result(result);
    bool __skreturn = has_row(__skparam__result);
    return __sklib__to_int(__skreturn);
}
...
int __sklib__query_column_for_bool__query_result__int(__sklib_query_result result, int col) {
    query_result __skparam__result = __sklib__to_query_result(result);
    int __skparam__col = __sklib__to_int(col);
    bool __skreturn = query_column_for_bool(__skparam__result, __skparam__col);
    return __sklib__to_int(__skreturn);
}
double __sklib__query_column_for_double__query_result__int(__sklib_query_result result, int col) {
    query_result __skparam__result = __sklib__to_query_result(result);
    int __skparam__col = __sklib__to_int(col);
    double __skreturn = query_column_for_double(__skparam__result, __skparam__col);
    return __sklib__to_double(__skreturn);
}
int __sklib__query_column_for_int__query_result__int(__sklib_query_result result, int col) {
    query_result __skparam__result = __sklib__to_query_result(result);
    int __skparam__col = __sklib__to_int(col);
    int __skreturn = query_column_for_int(__skparam__result, __skparam__col);
    return __sklib__to_int(__skreturn);
}
__sklib_string __sklib__query_column_for_string__query_result__int(__sklib_query_result result, int col) {
    query_result __skparam__result = __sklib__to_query_result(result);
    int __skparam__col = __sklib__to_int(col);
    string __skreturn = query_column_for_string(__skparam__result, __skparam__col);
    return __sklib__to_sklib_string(__skreturn);
}
int __sklib__query_success__query_result(__sklib_query_result result) {
    query_result __skparam__result = __sklib__to_query_result(result);
    bool __skreturn = query_success(__skparam__result);
    return __sklib__to_int(__skreturn);
}
__sklib_string __sklib__query_type_of_col__query_result__int(__sklib_query_result result, int col) {
    query_result __skparam__result = __sklib__to_query_result(result);
    int __skparam__col = __sklib__to_int(col);
    string __skreturn = query_type_of_col(__skparam__result, __skparam__col);
    return __sklib__to_sklib_string(__skreturn);
}
void __sklib__reset_query_result__query_result(__sklib_query_result result) {
    query_result __skparam__result = __sklib__to_query_result(result);
    reset_query_result(__skparam__result);
}
...
__sklib_drawing_options __sklib__option_rotate_bmp__float(float angle) {
    float __skparam__angle = __sklib__to_float(angle);
...
__sklib_drawing_options __sklib__option_rotate_bmp__float__float__float(float angle, float anchor_x, float anchor_y) {
    float __skparam__angle = __sklib__to_float(angle);
    float __skparam__anchor_x = __sklib__to_float(anchor_x);
    float __skparam__anchor_y = __sklib__to_float(anchor_y);
...
__sklib_drawing_options __sklib__option_scale_bmp__float__float(float scale_x, float scale_y) {
    float __skparam__scale_x = __sklib__to_float(scale_x);
    float __skparam__scale_y = __sklib__to_float(scale_y);
...
void __sklib__json_set_object__json__string__json(__sklib_json j, __sklib_string key, __sklib_json object) {
    json __skparam__j = __sklib__to_json(j);
    string __skparam__key = __sklib__to_string(key);
    json __skparam__object = __sklib__to_json(object);
    json_set_object(__skparam__j, __skparam__key, __skparam__object);
}
...
__sklib_line __sklib__line_from__point_2d_ref__point_2d_ref(const __sklib_point_2d start, const __sklib_point_2d end) {
    point_2d __skparam__start = __sklib__to_point_2d(start);
    point_2d __skparam__end = __sklib__to_point_2d(end);
    line __skreturn = line_from(__skparam__start, __skparam__end);
...
__sklib_matrix_2d __sklib__rotation_matrix__float(float deg) {
    float __skparam__deg = __sklib__to_float(deg);
...
float __sklib__angle_between__vector_2d_ref__vector_2d_ref(const __sklib_vector_2d v1, const __sklib_vector_2d v2) {
    ...
    float __skreturn = angle_between(__skparam__v1, __skparam__v2);
    return __sklib__to_float(__skreturn);
}
float __sklib__dot_product__vector_2d_ref__vector_2d_ref(const __sklib_vector_2d v1, const __sklib_vector_2d v2) {
    vector_2d __skparam__v1 = __sklib__to_vector_2d(v1);
    vector_2d __skparam__v2 = __sklib__to_vector_2d(v2);
    float __skreturn = dot_product(__skparam__v1, __skparam__v2);
    return __sklib__to_float(__skreturn);
}
...
float __sklib__vector_angle__vector_2d(const __sklib_vector_2d v) {
    ...
    float __skreturn = vector_angle(__skparam__v);
    return __sklib__to_float(__skreturn);
}
__sklib_vector_2d __sklib__vector_from_angle__float__float(float angle, float magnitude) {
    float __skparam__angle = __sklib__to_float(angle);
    float __skparam__magnitude = __sklib__to_float(magnitude);
...
__sklib_vector_2d __sklib__vector_limit__vector_2d_ref__float(const __sklib_vector_2d v, float limit) {
    vector_2d __skparam__v = __sklib__to_vector_2d(v);
    float __skparam__limit = __sklib__to_float(limit);
...
__sklib_vector_2d __sklib__vector_point_to_point__point_2d_ref__point_2d_ref(const __sklib_point_2d start, const __sklib_point_2d end) {
    point_2d __skparam__start = __sklib__to_point_2d(start);
    point_2d __skparam__end = __sklib__to_point_2d(end);
    vector_2d __skreturn = vector_point_to_point(__skparam__start, __skparam__end);
    return __sklib__to_sklib_vector_2d(__skreturn);
}
